...
pinecone.init(api_key=pinecone_api_key, environment=os.environ["ENVIRONMENT"])
...
For product related queries show 3-5 if available products in your knowledge base with the name, price, small combined description and image link button.
...
For Legal compliance, policies and related queries provide user with concise response.
